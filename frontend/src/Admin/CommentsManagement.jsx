  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-2 sm:p-4 lg:p-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4 sm:mb-6">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-600 mt-1">Manage and moderate customer reviews</p>
            </div>
          </div>
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
            <button
              onClick={() => setShowAdvancedFilters(!showAdvancedFilters)}
              className="flex items-center justify-center gap-2 px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors duration-200"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors duration-200"
            >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-4 sm:mb-6 lg:mb-8">
        <div className="bg-white p-3 sm:p-4 lg:p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-medium text-gray-600 mb-1">Total Comments</p>
              <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">{totalComments}</p>
              <p className="text-xs text-gray-500 mt-1">All time reviews</p>
            </div>
            <div className="p-2 sm:p-3 bg-gradient-to-r from-blue-100 to-indigo-100 rounded-lg">
              <FaComments className="w-4 h-4 sm:w-6 sm:h-6 text-blue-600" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-3 sm:p-4 lg:p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
          <div className="flex items-center justify-between">
            ...
            <div className="p-2 sm:p-3 bg-gradient-to-r from-yellow-100 to-orange-100 rounded-lg">
              <FaClock className="w-4 h-4 sm:w-6 sm:h-6 text-yellow-600" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-3 sm:p-4 lg:p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-lg sm:text-xl lg:text-2xl font-bold text-green-600">{approvalRate}%</p>
              <p className="text-xs text-gray-500 mt-1">Of total comments</p>
            </div>
            <div className="p-2 sm:p-3 bg-gradient-to-r from-green-100 to-emerald-100 rounded-lg">
              <FaCheckCircle className="w-4 h-4 sm:w-6 sm:h-6 text-green-600" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-3 sm:p-4 lg:p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
          <div className="flex items-center justify-between">
            ...
            <div className="p-2 sm:p-3 bg-gradient-to-r from-red-100 to-pink-100 rounded-lg">
              <FaBan className="w-4 h-4 sm:w-6 sm:h-6 text-red-600" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg border border-gray-100 mb-4 sm:mb-6 lg:mb-8">
        <div className="space-y-4">
          {/* Basic Filters */}
          <div className="flex flex-col gap-4">
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
              <div className="flex items-center gap-2">
                <FaFilter className="w-3 h-3 sm:w-4 sm:h-4 text-gray-500" />
              ...
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                <select
                  ...
                  className="px-3 sm:px-4 py-2 text-xs sm:text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white shadow-sm"
                >
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-8 sm:pl-10 pr-4 py-2 w-full text-xs sm:text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white shadow-sm"
              />
            </div>
          </div>
          ...
          {showAdvancedFilters && (
            <div className="pt-4 border-t border-gray-200">
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                <div className="flex items-center gap-2">
                  <FaSort className="w-3 h-3 sm:w-4 sm:h-4 text-gray-500" />
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors duration-200"
                  >
                    {filters.sortOrder === 'asc' ? <FaSortUp className="w-3 h-3 sm:w-4 sm:h-4" /> : <FaSortDown className="w-3 h-3 sm:w-4 sm:h-4" />}
                    <span className="hidden sm:inline">{filters.sortOrder === 'asc' ? 'Ascending' : 'Descending'}</span>
                    <span className="sm:hidden">{filters.sortOrder === 'asc' ? '↑' : '↓'}</span>
                  </button>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
              <select
                ...
                className="px-3 py-2 text-xs sm:text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white shadow-sm"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
              >
                {isProcessing ? (
                ...
                <span className="hidden sm:inline">Apply Action</span>
      ...
      {/* Enhanced Comments List - Mobile Responsive */}
      <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        {loading ? (
          ...
          <div className="p-8 sm:p-12 text-center">
            <div className="p-3 sm:p-4 bg-gray-50 rounded-full w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-4 flex items-center justify-center">
              <FaComments className="w-6 h-6 sm:w-8 sm:h-8 text-gray-400" />
            </div>
            <p className="text-sm sm:text-base text-gray-600 font-medium">No comments found</p>
          ...
          <div className="divide-y divide-gray-100">
            ...
            {comments.map((comment) => (
              <div key={comment._id} className="p-3 sm:p-6 hover:bg-gray-50 transition-colors duration-200">
                <div className="flex flex-col gap-4 sm:gap-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-start gap-3 sm:gap-4 mb-3 sm:mb-4">
                      ...
                      <div className="flex-shrink-0">
                        <div className="w-8 h-8 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center shadow-md">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-col gap-1 sm:gap-2 mb-2">
                          <div className="flex items-center gap-2">
                            <FaUser className="w-3 h-3 sm:w-4 sm:h-4 text-gray-500" />
                            <span className="text-xs sm:text-sm font-semibold text-gray-900">{comment.user?.name || 'Unknown User'}</span>
                          </div>
                          
                          <div className="flex items-center gap-2">
                            <FaBox className="w-3 h-3 sm:w-4 sm:h-4 text-gray-500" />
                            <span className="text-xs text-gray-600 truncate">{comment.product?.name || 'Unknown Product'}</span>
                          </div>
                        </div>
                    ...
                    <div className="mb-3 sm:mb-4">
                      <h4 className="font-bold text-gray-900 text-xs sm:text-sm mb-2">{comment.title}</h4>
                      <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">{comment.comment}</p>
                    </div>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
                          {comment.images.map((image, index) => (
                            <img
                              ...
                              className="w-full h-12 sm:h-16 object-cover rounded-lg cursor-pointer hover:opacity-80 transition-opacity"
                  ...
                  {/* Status and Actions - Mobile Responsive */}
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
                    <div className="flex items-center gap-2">
                      <span className={`inline-flex items-center gap-1 px-2 sm:px-3 py-1 text-xs font-semibold rounded-full border ${getStatusColor(comment.status)}`}>
                        {getStatusIcon(comment.status)}
                        <span className="hidden sm:inline">{comment.status}</span>
                        <span className="sm:hidden">{comment.status.charAt(0).toUpperCase()}</span>
                      </span>
                    </div>
                    ...
                    <div className="flex items-center gap-1 sm:gap-2">
                      {comment.status === 'pending' && (
                        <>
                          <button
                            ...
                            className="p-1.5 sm:p-2 text-green-600 bg-green-50 hover:bg-green-100 rounded-lg transition-colors duration-200 disabled:opacity-50"
                          ...
                          <button
                            ...
                            disabled={isProcessing}
                            className="p-1.5 sm:p-2 text-red-600 bg-red-50 hover:bg-red-100 rounded-lg transition-colors duration-200 disabled:opacity-50"
                      ...
                      <button
                        ...
                        className="p-1.5 sm:p-2 text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors duration-200"
                        title="View details"
                      >
      ...
      {(pagination.totalPages || 1) > 1 && (
        <div className="mt-4 sm:mt-6 lg:mt-8 bg-white p-4 sm:p-6 rounded-xl shadow-lg border border-gray-100">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center justify-center gap-1 sm:gap-2">
              <button
                ...
                className="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 py-1 sm:py-1.5 text-xs font-medium text-gray-700 bg-white border border-gray-300 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-50 hover:border-gray-400 transition-all duration-200"
              >
                <span>←</span>
                ...
                {Array.from({ length: Math.min(5, pagination.totalPages || 1) }, (_, i) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-2 py-1 sm:px-2 sm:py-1.5 text-xs font-medium rounded-lg transition-all duration-200 ${
      ...
      {/* Comment Detail Modal - Mobile Responsive */}
      {showCommentModal && selectedComment && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="fixed inset-0 backdrop-blur-sm bg-black/30 transition-opacity duration-300"></div>
          <div className="flex min-h-full items-center justify-center p-2 sm:p-4">
            <div className="relative w-full max-w-lg sm:max-w-2xl max-h-[90vh] overflow-hidden">
              <div className="relative bg-white rounded-xl shadow-2xl overflow-hidden">
                <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
                  <h2 className="text-base sm:text-lg font-bold text-gray-900">Comment Details</h2>
                  <button
                ...
                <div className="p-4 sm:p-6 max-h-[calc(90vh-120px)] overflow-y-auto">
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      <div>
                        <h3 className="text-xs sm:text-sm font-semibold text-gray-900">{selectedComment.user?.name || 'Unknown User'}</h3>
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 text-xs sm:text-sm mb-2">{selectedComment.title}</h4>
                      <p className="text-xs sm:text-sm text-gray-700 leading-relaxed whitespace-pre-wrap">{selectedComment.comment}</p>
                    </div>
