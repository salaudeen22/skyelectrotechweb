            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 border-b border-gray-200">
              ...
              <div className="flex items-center space-x-2">
                <button
                  onClick={handleMarkAsRead}
                  disabled={isMarkingRead}
                  className="flex items-center space-x-1 px-3 py-2 text-sm bg-blue-500 text-white rounded-lg hover:bg-blue-600 disabled:opacity-50"
                >
                  <FiCheck className="w-4 h-4" />
                  <span>Mark Read</span>
                </button>
                <button
                  onClick={handleDeleteSelected}
                  disabled={isDeleting}
                  className="flex items-center space-x-1 px-3 py-2 text-sm bg-red-500 text-white rounded-lg hover:bg-red-600 disabled:opacity-50"
                >
          ...
          <div className="p-4 border-t border-gray-200 bg-gray-50">
            <div className="flex items-center justify-between">
              ...
              <Link
                to="/notifications/settings"
                onClick={onClose}
                className="flex items-center space-x-2 text-base text-gray-500 hover:text-gray-700"
              >
