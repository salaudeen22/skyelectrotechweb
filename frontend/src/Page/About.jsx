    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="text-center p-4 rounded-lg bg-blue-50 border border-blue-100">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Comprehensive Catalog</h3>
                <p className="text-gray-600 text-sm">
              ...
              <div className="text-center p-4 rounded-lg bg-teal-50 border border-teal-100">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Innovation Ready</h3>
                <p className="text-gray-600 text-sm">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-lg p-8 text-center text-white mb-8">
            <h2 className="text-2xl font-bold mb-4">Join India's Innovation Revolution</h2>
