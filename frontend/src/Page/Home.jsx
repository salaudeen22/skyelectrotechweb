  ...
  return (
    <div className="bg-gray-50 min-h-screen flex flex-col">
      ...
      <div className="flex-1 pt-0"> {/* Changed from main to div and added flex-1 */} 
        ...
        {/* Popular Electronic Components Section - Targeting Search Console Queries */}
        <section className="bg-gray-50">
          <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">
                Popular Electronic Components in Bangalore
              </h2>
              <p className="mt-4 text-lg text-gray-600">
                Arduino, Sensors, Displays & Timer ICs - All Available with Same-Day Delivery
              </p>
            </div>

            {/* Product Grid targeting search queries */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                <div className="p-6">
                  <div className="flex items-center mb-4">
                    <FiTool className="w-8 h-8 text-blue-600 mr-3" />
                    <h3 className="text-xl font-bold text-gray-900">MAX7219 Display Modules</h3>
                  </div>
                  <p className="text-gray-600 mb-4">
                    8-digit LED display driver modules, MAX7219 display controllers for Arduino projects. 
                    Perfect for digital clocks, counters and scoreboards.
                  </p>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-500">Starting from ₹150</span>
                    <Link 
                      to="/products?search=MAX7219" 
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                <div className="p-6">
                  <div className="flex items-center mb-4">
                    <FiTool className="w-8 h-8 text-green-600 mr-3" />
                    <h3 className="text-xl font-bold text-gray-900">Humidity Sensor Modules</h3>
                  </div>
                  <p className="text-gray-600 mb-4">
                    DHT11, DHT22 humidity sensor modules for weather monitoring, greenhouse automation. 
                    High accuracy temperature and humidity sensors.
                  </p>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-500">Starting from ₹120</span>
                    <Link 
                      to="/products?search=humidity" 
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                <div className="p-6">
                  <div className="flex items-center mb-4">
                    <FiTool className="w-8 h-8 text-purple-600 mr-3" />
                    <h3 className="text-xl font-bold text-gray-900">NE555 Timer ICs</h3>
                  </div>
                  <p className="text-gray-600 mb-4">
                    NE555 precision timer ICs, NE555 timer circuits for oscillators, pulse generators 
                    and delay circuits. Essential for electronics projects.
                  </p>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-500">Starting from ₹15</span>
                    <Link 
                      to="/products?search=NE555" 
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                <div className="p-6">
                  <div className="flex items-center mb-4">
                    <FiCamera className="w-8 h-8 text-red-600 mr-3" />
                    <h3 className="text-xl font-bold text-gray-900">Obstacle Detection Sensors</h3>
                  </div>
                  <p className="text-gray-600 mb-4">
                    IR obstacle sensors, ultrasonic HC-SR04 modules for robotics, obstacle avoidance 
                    systems. Perfect for autonomous robots and security systems.
                  </p>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-500">Starting from ₹80</span>
                    <Link 
                      to="/products?search=obstacle" 
                      className="bg-red-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-red-700 transition-colors"
                    >
                      View Obstacle Sensors
                    </Link>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                <div className="p-6">
                  <div className="flex items-center mb-4">
                    <FiTool className="w-8 h-8 text-blue-600 mr-3" />
                    <h3 className="text-xl font-bold text-gray-900">Arduino Development Boards</h3>
                  </div>
                  <p className="text-gray-600 mb-4">
                    Arduino Uno, Nano, ESP32 development boards. Complete starter kits and shields 
                    for electronics prototyping and project development.
                  </p>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-500">Starting from ₹300</span>
                    <Link 
                      to="/products?search=arduino" 
                      className="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors"
                    >
                      View Arduino Boards
                    </Link>
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                <div className="p-6">
                  <div className="flex items-center mb-4">
                    <FiSearch className="w-8 h-8 text-indigo-600 mr-3" />
                    <h3 className="text-xl font-bold text-gray-900">Electronic Components Shop</h3>
                  </div>
                  <p className="text-gray-600 mb-4">
                    Looking for electronic components shop near me in Bangalore? Visit SkyElectroTech 
                    at Nagarathpete for all your electronics needs with expert technical support.
                  </p>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-500">Visit our store</span>
                    <Link 
                      to="/contact" 
            ...
            <div className="text-center mt-12">
              <div className="bg-blue-600 text-white rounded-lg p-6">
                ...
                <p className="text-blue-100 mb-6">
                  Call us at <a href="tel:+916361241811" className="font-bold text-white hover:underline">+91 6361241811</a> or 
                  email <a href="mailto:skyelectrotechblr@gmail.com" className="font-bold text-white hover:underline">skyelectrotechblr@gmail.com</a> for technical support
                </p>
