        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 flex-1">
          ...
          <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 lg:p-8">
            <div className="prose max-w-none text-sm sm:text-base">
              <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">1. Acceptance of Terms</h2>
              ...
              <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">4. Pricing and Payment</h2>
              <p className="text-gray-700 mb-3 sm:mb-4">
              ...
              <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">7. Warranty and Support</h2>
              <p className="text-gray-700 mb-3 sm:mb-4">
              ...
              <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">8. User Accounts</h2>
              <p className="text-gray-700 mb-3 sm:mb-4">
              ...
              <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">9. Prohibited Uses</h2>
              <p className="text-gray-700 mb-3 sm:mb-4">
              ...
              <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">10. Intellectual Property</h2>
              <p className="text-gray-700 mb-4 sm:mb-6">
              ...
              <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">11. Limitation of Liability</h2>
              <p className="text-gray-700 mb-4 sm:mb-6">
              ...
              <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">12. Indemnification</h2>
              <p className="text-gray-700 mb-4 sm:mb-6">
              ...
              <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">13. Governing Law</h2>
              <p className="text-gray-700 mb-4 sm:mb-6">
              ...
              <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">14. Changes to Terms</h2>
              <p className="text-gray-700 mb-4 sm:mb-6">
              ...
              <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">15. Contact Information</h2>
              <p className="text-gray-700 mb-3 sm:mb-4">
