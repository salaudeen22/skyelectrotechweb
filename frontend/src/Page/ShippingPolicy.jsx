        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-white rounded-lg shadow-sm p-8">
            <div className="prose max-w-none">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">1. Shipping Coverage</h2>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-6">2. Shipping Methods & Delivery Times</h2>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-6">3. Shipping Charges</h2>
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                <h3 className="text-lg font-semibold text-blue-900 mb-3">Free Shipping</h3>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-6">4. Order Processing Time</h2>
              <ul className="list-disc pl-6 text-gray-700 mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-6">5. Tracking Your Order</h2>
              <p className="text-gray-700 mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-6">6. Delivery Guidelines</h2>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-6">7. Special Circumstances</h2>
              
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Remote Areas</h3>
              <p className="text-gray-700 mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Monsoon & Natural Disasters</h3>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Festival Seasons</h3>
              <p className="text-gray-700 mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-6">8. Delivery Issues</h2>
              
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Failed Delivery Attempts</h3>
              <ul className="list-disc pl-6 text-gray-700 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Damaged or Missing Items</h3>
              <p className="text-gray-700 mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-6">9. International Shipping</h2>
              <p className="text-gray-700 mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-6">10. Address Change Policy</h2>
              <ul className="list-disc pl-6 text-gray-700 mb-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-gray-700">
                  <strong>Email:</strong> shipping@skyelectrotech.com<br />
